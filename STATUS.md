...
> This file is the source of truth for project health and progress at a glance.
...
>
> This file is a dashboard, not a log. Detailed phase-by-phase narrative, regression
> analysis, deviations, and design discussion for a story belong in that story's own
> log file at `docs/specs/status/story-XXX-log.md`. STATUS.md gets a one-line status
> per story only, with a link to the log for anyone who wants the full trace.
...
Autonomous Agentic Workflow epic complete (STORY-003, STORY-004). Personal Streaming Library epic
defined by PO: STORY-005 through STORY-019 specced and queued for Test and Dev.
...
- [ ] STORY-008: Add TV Series from TMDB to Library (`docs/specs/story-008-add-series-from-tmdb.md`) - prereq STORY-006 - Implementation complete, PR open, awaiting Test verification - Full trace: `docs/specs/status/story-008-log.md`
...
| STATUS.md is a dashboard, not a log | Story-by-story phase narrative, regression analysis, and deviation notes moved to per-story log files under `docs/specs/status/`, so STATUS.md stays a fast, current at-a-glance view while the detailed trace Brian relies on for PR review is preserved and scoped to one story at a time (2026-09-10) |
