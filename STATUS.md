...
- [ ] STORY-008: Add TV Series from TMDB to Library (`docs/specs/story-008-add-series-from-tmdb.md`) - prereq STORY-006 - Design agreed, starting implementation - Full trace: `docs/specs/status/story-008-log.md`
