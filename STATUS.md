...
- [ ] STORY-008: Add TV Series from TMDB to Library (`docs/specs/story-008-add-series-from-tmdb.md`) - prereq STORY-006 - Dev feedback round 1 sent, awaiting Test revision - Full trace: `docs/specs/status/story-008-log.md`
